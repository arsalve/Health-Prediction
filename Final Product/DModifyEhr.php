...
float: right;
font-size: 16px;"><a href="dashbord.php?logout='1'" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        </nav>   
           <!-- /. NAV TOP  -->
				...
				<li class="text-center">
                   ...
                   <li>
                        <a   href="Gre.php"><i class="fa fa-qrcode fa-3x"></i>Find Patient</a>
						   ...
						   <li>
                        <a class="active-menu"  href="DModifyEhr.php"><i class="fa fa-bar-chart-o fa-3x"></i> Modify a Record</a>
                    </li>	
                </ul>
	...
	?>
            ...
            <div id="page-inner">
				...
				<div class ="row">
					...
					<form class="contact100-form" method="post"  action="DModifyEhr.php">
