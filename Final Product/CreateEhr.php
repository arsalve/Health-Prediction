            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                     ...
                     <li>
                        <a  class="active-menu" href="createEHR.php"><i class="fa fa-desktop fa-3x"></i> Create a Record</a>
                    </li>
                    <li>
            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h3><?php echo  "Created BY  "; echo $_SESSION['username']; ?></h3>
                    </div>
                </div>
				
				<div class ="row">
				
					<form class="contact100-form" method="post"  action="CreateEhr.php">
