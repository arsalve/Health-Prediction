   ...
   <?php    //calculating Age
    ...
    <hr><hr>Your heart Details<hr>
		<form method="post"  action="Dashbord.php" >
          <table border=1px style="overflow-x: auto;">
            <tr>
...
if ($out==2){
	...
	echo "<h1>Positive  your heart may ran into trubble so you can do</h1> <br><p><h2><b>Eat to be your best:-</b> Add plenty of fruits and veggies, grains, and foods high in omega-3 fatty acids like fresh tuna or herring to your diet. Cut down on salt, saturated fats, sweets, and red meats. Avoid trans fats and food with “hydrogenated” or “partially hydrogenated” ingredients. Variety in your diet is a good way to get all the nutrients you need.
<br>
  <b> Take it easy :- </b> Find a relaxation method that works for you. Yoga, meditation, dedicated time to unwind after work -- these can help keep your stress levels down. Stressful emotions such as anger and hostility may also lead to heart attack risk, so keep calm and be cool. 
